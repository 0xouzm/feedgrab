...
> **项目来源**：feedgrab 是在 [@runes_leo](https://x.com/runes_leo) 的 [x-reader](https://github.com/runesleo/x-reader) 和 [@dotey](https://x.com/dotey)（宝玉）的 [baoyu-danger-x-to-markdown](https://github.com/anthropics/claude-code/tree/main/skills) Claude Code 技能基础上融合升级而来。继承了 x-reader 的多平台架构，融合了宝玉 skill 逆向工程的 X/Twitter GraphQL 深度抓取能力。
...
Tier 0（GraphQL）移植自 [baoyu-danger-x-to-markdown](https://github.com/anthropics/claude-code) 技能，特性包括：
...
- **[baoyu-danger-x-to-markdown](https://github.com/anthropics/claude-code)** — 由 [@dotey](https://x.com/dotey)（宝玉）开发的 X/Twitter 深度抓取技能，提供了逆向工程的 GraphQL API 访问、线程重建和 Markdown 渲染能力。
