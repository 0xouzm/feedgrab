...
| 平台 | 抓取方式 |
|------|---------|
| X/Twitter | GraphQL → Syndication → oEmbed → Jina → Playwright（五级兜底） |
...
Tier 0 GraphQL（需Cookie）→ Tier 0.5 Syndication（免费无认证）→ Tier 1 oEmbed → Tier 2 Jina → Tier 3 Playwright
